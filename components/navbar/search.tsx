...
const Search: React.FC = () => {
  ...
  return (
    <div className="rounded-full flex items-center to-gray-500 ml-4 bg-[#f5f8ff] relative">
      ...
      {isDropdownVisible && searchResults.length > 0 && (
        <ul className="absolute top-full left-0 w-full bg-white shadow-md rounded-md mt-2 z-10 border">
